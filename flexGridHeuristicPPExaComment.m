...
for iterCase = 1:1 %iterations for the case under analysis
    ...
    for iterFs = 0:3 %iterations for Fs %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %--- Number of partitions
        partInfo = 2; %number of partitions to perform the pre-partitioning strategy
        ...
        for i = 1:n
            ...
            %services(i,4) = freqCentral + randi([-n n],1,1) * fsWidth; %serviceFc(i);
...
%             disp(prepart);
            ...
            auxPwRefLevel = BWFsServPart + 1; %updated value of auxiliar variable
...
solHeurFlexGrid = [caseInfo,frecShiftingInfo,acceptanceRatioInfo,useAvaBWInfo,...
    useAvaBWpercentInfo,numFreqShiftinInfo,cumFreqShiftinInfo];
save('solHeurFlexGrid.mat','solHeurFlexGrid',...
